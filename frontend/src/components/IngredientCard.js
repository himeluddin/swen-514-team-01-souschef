            ...
            <div class="p-3 max-w-sm w-full lg:max-w-full lg:flex">
                ...
                <div class="w-full border border-gray-400 lg:border-gray-400 bg-white rounded-tr rounded-br p-4 flex flex-col justify-between leading-normal">
                        <div class="flex items-center card-button">
                            <button class="h-12 w-12 p-0 mt-2 mr-2 relative transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                <img src={close} alt="Close Button"></img>
                            </button>
                        </div>
                    <div class="text-gray-900 font-bold text-4xl">Apple</div>
                    <div class="flex items-center card-button">
                        <button class="relative card-button inline-flex p-0.5 mr-2 mb-0 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800">
